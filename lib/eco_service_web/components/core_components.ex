defmodule EcoServiceWeb.CoreComponents do
  @moduledoc """
  ...
  def modified_input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      <input
        ...
        value={Phoenix.HTML.Form.normalize_value(@type, @value)}
        class={[
          "mr-2 rounded-full border-zinc-300 ",
          "text-zinc-900 focus:outline-none focus:ring-4 sm:text-sm sm:leading-6",
          "phx-no-feedback:border-zinc-300 phx-no-feedback:focus:border-zinc-400 phx-no-feedback:focus:ring-zinc-800/5",
          "border-zinc-300 focus:border-zinc-400 focus:ring-zinc-800/5",
          @errors != [] && "border-rose-400 focus:border-rose-400 focus:ring-rose-400/10"
        ...
        {@rest}
      />
      <.modified_label for={@id}><%= @label %></.modified_label>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EcoServiceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EcoServiceWeb.Gettext, "errors", msg, opts)
    end
  end
