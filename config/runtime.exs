...
#
#     PHX_SERVER=true bin/eco_service start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :eco_service, EcoServiceWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :eco_service, EcoService.Repo,
    ssl: true,
    url: database_url,
  ...
  config :eco_service, EcoServiceWeb.Endpoint,
  ...
  #
  #     config :eco_service, EcoService.Mailer,
